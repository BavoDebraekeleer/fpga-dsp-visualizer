...
entity btn_counter4bit_up_looping is
    Port (
...
end btn_counter4bit_up_looping;
 
architecture Behavioral of btn_counter4bit_up_looping is
...
begin
    ...
    begin
        if rising_edge(clk_100MHz) then
            if (reset = '1') or (counter = (count_max + 1)) then
                counter <= "0000";
