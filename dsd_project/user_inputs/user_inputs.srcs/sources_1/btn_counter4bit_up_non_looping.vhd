...
entity btn_counter4bit_up_non_looping is
    Port (
...
end btn_counter4bit_up_non_looping;
 
architecture Behavioral of btn_counter4bit_up_non_looping is
...
begin
    ...
    begin
        if rising_edge(clk_100MHz) then
            if reset = '1' then
                counter <= "0000";
            elsif (btn_pulse = '1') and (counter < count_max) then
                counter <= counter + 1;
            end if; 
        end if;
    end process;
