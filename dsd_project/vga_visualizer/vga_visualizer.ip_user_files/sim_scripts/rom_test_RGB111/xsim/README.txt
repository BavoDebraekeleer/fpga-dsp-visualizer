...
#
# Generated by export_simulation on Thu Aug 10 13:54:49 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './rom_test_RGB111.sh' script.

./rom_test_RGB111.sh -reset_run
...
./rom_test_RGB111.sh -noclean_files

For more information on the script, please type './rom_test_RGB111.sh -help'.
