...
def Convert (ImageName):
	...
	imgcoe.write(b'; .COE file with binary coefficients\n')
	imgcoe.write(bytes('; Height: ' + str(height) + ', Width: ' + str(width) + '\n', 'utf-8'))
	imgcoe.write(b'memory_initialization_radix = 2;\n')
	...
	for r in range(0, height):
		for c in range(0, width):
			...
			try:
				imgcoe.write(bytes(Outbyte, 'utf-8'))
			except ValueError:
